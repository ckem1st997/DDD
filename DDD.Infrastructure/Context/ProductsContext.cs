...
namespace DDD.Infrastructure.Context
{
    ...
    {
        public const string DEFAULT_SCHEMA = "tets";
        public const string STRING_CONNECT = @"Data Source=DESKTOP-ITLR9T6\SQLEXPRESS;Initial Catalog=tets;Integrated Security=True";
    ...
    public class ProductsContextDesignFactory : IDesignTimeDbContextFactory<ProductsContext>
    {
        public ProductsContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<ProductsContext>()
                .UseSqlServer(@"Data Source=DESKTOP-ITLR9T6\SQLEXPRESS;Initial Catalog=tets;Integrated Security=True");
